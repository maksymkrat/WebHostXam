...
namespace WebHostXam.Android
{
    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        private ExtraOffer Offer1 = null;
        private ExtraOffer Offer2 = null;
        ...
        public void StartReceipt(ReceiptModel receipt)
        {
            ...
            if (receipt != null)
            {
                RunOnUiThread((() =>
                {
                    ...
                    offerOldPrice1.Text = receipt.Offer1.OldPrice.ToString();
                    offerNewPrice1.Text = receipt.Offer1.NewPrice.ToString();
                    ...
                    offerOldPrice2.Text = receipt.Offer2.OldPrice.ToString();
                    offerNewPrice2.Text = receipt.Offer2.NewPrice.ToString();
