    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        protected async override void OnResume()
        {
           ...
           // html = viewManager.HTML;
            ...
            if (Preferences.Get(FILES_DOWNLOADED, "false").Equals("true"))
            {
                upperWebView.LoadData(bodyStyle + html, "text/html", null);
            }
            else
            {
                upperWebView.LoadData(bodyStyle + loaderHTML, "text/html", null); 
            }
        }
        ...
        public void Initialize()
        {
            ...
            viewManager.ActionFilesDownloaded += ChangeUpperView;
